...
```html
<div
  class="of-hidden flex h-screen w-screen flex-col bg-base font-sans color-base"
>
  <header
  ...
  >
    ...
    <span class="truncate font-mono text-xs" title="workspace-name"
      >workspace-name</span
    >
  </header>
  ...
  <main class="of-auto min-h-0 flex-1">
    <div class="flex items-center gap-2 p-4">
      <span
        class="text-micro inline-flex items-center gap-1 rounded border border-active bg-active px-1.5 py-px tracking-wide color-active uppercase"
      >
        active
      </span>
