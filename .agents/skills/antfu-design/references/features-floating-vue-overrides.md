...
.v-popper--theme-tooltip .v-popper__inner {
  @apply bg-tooltip rounded border border-base font-sans color-base shadow dark:shadow-2xl;
...
.v-popper--theme-dropdown .v-popper__arrow-inner {
  visibility: visible;
  @apply dark:border-#111 border-white;
}
...
```html
<div class="bg-tooltip rounded border border-base text-sm color-base shadow">
  tooltip content
</div>
```
