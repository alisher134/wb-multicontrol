...
```html
<header class="flex h-10 items-center gap-2 border-b border-base bg-base px-3">
...
<span
  class="text-micro inline-flex items-center gap-1 rounded border border-active bg-active px-1.5 py-px font-mono color-active"
>
  open
</span>
...
shortcuts: [
  {
    ...
    'app-shell':
      'w-screen h-screen flex flex-col of-hidden bg-base color-base font-sans',
    'scroll-touch':
...
<div class="app-shell pad-safe">
  <header
    class="h-nav flex items-center gap-2 border-b border-base bg-base px-3"
  >
  ...
  <main class="of-auto scroll-touch min-h-0 flex-1">
